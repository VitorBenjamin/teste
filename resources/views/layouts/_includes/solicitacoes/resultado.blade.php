							...
							<div class="col-md-2">
								<div class="form-group">
									<div class="form-line">
										...
										<input type="text" name="data_inicial" class="datepicker form-control" placeholder="Escolha uma Data" required />
									</div>
								</div>
							</div> 
							<div class="col-md-2">
								<div class="form-group">
									<div class="form-line">
										...
										<input type="text" name="data_final" class="datepicker form-control" placeholder="Escolha uma Data" required />
									</div>
								</div>
							</div>
