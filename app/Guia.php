...
class Guia extends Model
{
     ...
     */
    protected $fillable = [
    	'data_limite','data_comprovante','estornado','prioridade','observacao','reclamante','perfil_pagamento','banco','anexo_comprovante','anexo_guia','valor','solicitacoes_id','tipo_guias_id'
    ];
