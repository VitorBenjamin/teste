...
Route::group(['prefix' => 'solicitacao'],function(){
    ...
    Route::get('/reembolso/editar/{id}', ['uses' => 'ReembolsoController@editar', 'as' => 'reembolso.editar']);
    ...
    Route::get('/reembolso/addtranslado/{id}', ['uses' => 'ReembolsoController@addTranslado', 'as' => 'reembolso.addTranslado']);
    Route::get('/reembolso/addDespesa/{id}', ['uses' => 'ReembolsoController@addDespesa', 'as' => 'reembolso.addDespesa']);
